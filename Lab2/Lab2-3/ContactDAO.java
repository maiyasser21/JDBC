...
//    private final String PASSWORD = "root";
    ...
    public void testBatch() {
        String sql1 = "UPDATE contact SET email='test22@gmail.com' WHERE name='Mai'";
        String sql2 = "UPDATE contact SET email='test222@gmail.com' WHERE name='salma'";
        String sql3 = "UPDATE contact SET email='test22@gmail.com' WHERE name='kamal'";
        if (conflag)
        {
            try{
